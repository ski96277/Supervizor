...
public class MyLeaveApplicationReceptionistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_leave_application_receptionist_f);
        //hide notofication bar
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        getSupportActionBar().setTitle("Leave Application List");
        initView();


        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MyLeaveApplicationReceptionistActivity.this);
        ...
        kAlertDialog.show();
        if (!CheckInternet.isInternet(MyLeaveApplicationReceptionistActivity.this)) {
            Toasty.error(MyLeaveApplicationReceptionistActivity.this, "Check internet Connection").show();
...
//                            }
                                ...
                                if (leaveApplication_pojoClasses_list.size() == 0) {
                                    kAlertDialog.dismissWithAnimation();
                                    Toasty.info(MyLeaveApplicationReceptionistActivity.this, "No data found").show();
                                    return;
                                }
...
//set adapter
                            ...
                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                Toasty.info(MyLeaveApplicationReceptionistActivity.this, "have some problem try it later").show();
                            }
                        });
    ...
    private void initView() {
        ...
        kAlertDialog = new KAlertDialog(MyLeaveApplicationReceptionistActivity.this, KAlertDialog.PROGRESS_TYPE);
    }

    @Override
    public void onBackPressed() {

        startActivity(new Intent(MyLeaveApplicationReceptionistActivity.this, ReceptionistMainActivity.class)
