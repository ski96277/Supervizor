...
class All_Leave_Application_List_Receptionist_Adapter(var leaveApplication_pojoClasses_list: List<LeaveApplication_PojoClass>, image_link: String?) : RecyclerView.Adapter<All_Leave_Application_List_Receptionist_Adapter.ViewHolderClass>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderClass {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_all_leave_application_receptionist, parent, false)
...
itemView.leave_status_icon_id_IV.setImageResource(R.drawable.accepted_icon)
        ...
        private fun showDialog_details(itemView: View, leaveApplication_PojoClass: LeaveApplication_PojoClass) {
            ...
            dialog.setContentView(R.layout.custom_alert_dialog_my_leave_application_show_receptionist)
