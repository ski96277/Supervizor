...
import kotlinx.android.synthetic.main.event_list_item_view__by_team_member.view.*

class Team_Event_List_Adapter_View_by_Team_member(var event_details_team_pojoClasses: MutableList<Event_Details_Team_PojoClass>) : RecyclerView.Adapter<Team_Event_List_Adapter_View_by_Team_member.ViewHolder>()  {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.event_list_item_view__by_team_member, parent, false)
    ...
    class ViewHolder(var itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        fun setData(event_details_team_pojoClasses: Event_Details_Team_PojoClass) {
            ...
            itemview.event_title_TV_item_ID_view_by_team_member.text = event_details_team_pojoClasses!!.event_title
            itemview.event_Date_TV_item_ID_view_by_team_member.text = event_details_team_pojoClasses!!.date
            itemview.event_time_TV_item_ID_view_by_team_member.text = event_details_team_pojoClasses!!.event_time
