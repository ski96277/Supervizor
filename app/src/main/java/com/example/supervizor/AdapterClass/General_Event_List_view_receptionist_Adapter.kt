...
import kotlinx.android.synthetic.main.custom_alert_dialog_event_show_receptionist.*
import kotlinx.android.synthetic.main.general_event_list_item_view_receptionist.view.*

class General_Event_List_view_receptionist_Adapter(var context: Context?,var event_details_pojoClassList: MutableList<Event_details_PojoClass>) : RecyclerView.Adapter<General_Event_List_view_receptionist_Adapter.ViewHolder>()  {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(context).inflate(R.layout.general_event_list_item_view_receptionist, parent, false);
    ...
    override fun getItemCount(): Int {
        ...
        return event_details_pojoClassList.size
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {

        return holder.setData(event_details_pojoClassList[position])
    }


    class ViewHolder(var itemview: View) : RecyclerView.ViewHolder(itemview) {

        fun setData(event_details_PojoClass: Event_details_PojoClass?) {
        ...
        private fun show_Event_Information(itemview: View, event_details_PojoClass: Event_details_PojoClass) {
            ...
            dialog.setContentView(R.layout.custom_alert_dialog_event_show_receptionist)
