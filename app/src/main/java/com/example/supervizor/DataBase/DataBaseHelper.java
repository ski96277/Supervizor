...
/*public static String createTable="CREATE TABLE "+DATABASE_TABLE_NAME+" ( "+COL_USER_ID+
        " INTEGER PRIMARY KEY, "+
    ...
    public static String CREATE_TABLE =
            "CREATE TABLE " + DATABASE_TABLE_NAME + " ( " +
                    ...
                    COL_EMAIL + " TEXT ," +
                    COL_PHONE + " TEXT ,"+
                    COL_COMPANIESWORKINGDAYSS + " TEXT ," +
                    COL_ATTENDANCECOUNT + " TEXT ," +
                    COL_BASICSALARY + " TEXT ,"+
                    COL_TOTALSALARY + " TEXT ," +
                    COL_BONUSSALARY + " TEXT ," +
                    COL_SALARYFINE + " TEXT ,"+
                    COL_PAYABLESALARY + " TEXT );";
    /*
    public static String CREATE_TABLE =
            "CREATE TABLE " + DATABASE_TABLE_NAME + " ( " +
                    COL_USER_ID + " INTEGER PRIMARY KEY, " +
